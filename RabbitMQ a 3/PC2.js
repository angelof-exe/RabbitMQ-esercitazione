...
const queue_send = process.env.queue_2; // Nome della query su cui inviare il messaggio
const queue_receive = process.env.queue_1; // Nome della query da ricevere
...
amqp.connect(`amqp://${username}:${password}@${IP_addr}:${IP_port}`, function (error0, connection) {
    ...
    connection.createChannel(function (error1, channel) {
        ...
        var msg_send = "PC2"; // Messaggio da inviare
